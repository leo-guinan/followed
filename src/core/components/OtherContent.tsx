...
import { BarsArrowUpIcon, ChevronDownIcon, ChevronRightIcon, StarIcon } from "@heroicons/react/20/solid"
  ...
  return (
    <>
      <div className="bg-white lg:min-w-0 lg:flex-1">
        <div
          className="border-b border-t border-gray-200 pl-4 pr-6 pt-4 pb-4 sm:pl-6 lg:pl-8 xl:border-t-0 xl:pl-6 xl:pt-6">
